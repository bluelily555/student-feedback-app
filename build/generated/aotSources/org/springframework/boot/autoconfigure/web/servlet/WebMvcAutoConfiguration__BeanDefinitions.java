...
public class WebMvcAutoConfiguration__BeanDefinitions {
   ...
   */
  private static BeanInstanceSupplier<OrderedHiddenHttpMethodFilter> getHiddenHttpMethodFilterInstanceSupplier(
      ) {
    return BeanInstanceSupplier.<OrderedHiddenHttpMethodFilter>forFactoryMethod(WebMvcAutoConfiguration.class, "hiddenHttpMethodFilter")
            .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean(WebMvcAutoConfiguration.class).hiddenHttpMethodFilter());
  }
  ...
  public static BeanDefinition getHiddenHttpMethodFilterBeanDefinition() {
    Class<?> beanType = OrderedHiddenHttpMethodFilter.class;
    RootBeanDefinition beanDefinition = new RootBeanDefinition(beanType);

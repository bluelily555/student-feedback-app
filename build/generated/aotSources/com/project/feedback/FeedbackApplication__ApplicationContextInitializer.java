 ...
 */
public class FeedbackApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new FeedbackApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new FeedbackApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }

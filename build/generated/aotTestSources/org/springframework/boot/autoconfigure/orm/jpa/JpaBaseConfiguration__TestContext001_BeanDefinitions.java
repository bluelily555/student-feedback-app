...
public class JpaBaseConfiguration__TestContext001_BeanDefinitions {
  ...
  public static BeanDefinition getEntityManagerFactoryBeanDefinition() {
    ...
    beanDefinition.setDependsOn("dataSourceScriptDatabaseInitializer","org.springframework.context.config.internalBeanConfigurerAspect");
  ...
  public static class PersistenceManagedTypesConfiguration__BeanDefinitions {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("com.project.feedback.domain.entity.BaseEntity", "com.project.feedback.domain.entity.BoardEntity", "com.project.feedback.domain.entity.CodeEntity", "com.project.feedback.domain.entity.CommentEntity", "com.project.feedback.domain.entity.CourseEntity", "com.project.feedback.domain.entity.CourseEntityUser", "com.project.feedback.domain.entity.RepositoryEntity", "com.project.feedback.domain.entity.TaskEntity", "com.project.feedback.domain.entity.TimeEntity", "com.project.feedback.domain.entity.User");
